...
namespace RestClientApp
{
    class Program
    {
        ...
        {
            string baseUrl = "https://test.faros.cl:2083/api/v1/companies/token";
        ...
        {
            string url = "https://test.faros.cl:2083/api/v1/loadDocument/";
        ...
        public static async Task UploadFileAsync(string filePath, string bearerToken, string description)
        {
            ...
            {
                HttpClient client = new HttpClient();
                var url = $"https://test.faros.cl:2083/api/v1/loadFile/upload?description={description}";
